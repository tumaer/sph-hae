"""
Steerable E(3) equivariant GNN. Model + equivariant blocks + steerable feature transform

https://github.com/gerkone/segnn-jax
"""
import warnings
...
class SEGNN(hk.Module):
    ...
    def _transform(self, features: Dict[str, jnp.ndarray]) -> SteerableGraphsTuple:
    ...
    def __call__(self, features: Dict[str, jnp.ndarray]) -> jnp.array:
